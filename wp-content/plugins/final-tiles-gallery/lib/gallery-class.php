...
if (!class_exists("FinalTilesGallery"))
{
	class FinalTilesGallery
	{
		...
		public function render()
		{
			...
			$html .= "<div class='final-tiles-gallery captions-$captionBehavior hover-$gallery->captionEffect ". ($gallery->captionFullHeight == 'T' ? "caption-full-height" : "caption-auto-height") ."' id='ftg-$this->id$rid' style='width:$gallery->width'>\n";
		...
		public function images_markup()
		{
			...
			foreach($this->images as $image)
			{
				...
				$html .= "<div $data_keep_aspect_ratio class='tile $hiddenClass ". FinalTilesGallery::getFilters($image->filters) ."'>\n";
